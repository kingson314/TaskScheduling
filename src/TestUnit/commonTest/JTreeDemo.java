...
public class JTreeDemo {
	...
	public static void main(String[] args) {
		...
		panel.add(new SScrollPane(example1)); // JTree必须放在SScrollPane上
		panel.add(new SScrollPane(example2));
		panel.add(new SScrollPane(example3));
		panel.add(new SScrollPane(example4));
		panel.add(new SScrollPane(example5));
		panel.add(new SScrollPane(example6));
		panel.add(new SScrollPane(example7));
