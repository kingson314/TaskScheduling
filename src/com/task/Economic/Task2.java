...
//	// 插入经济数据记录sql
//	private String sqlInsertEconomicData = "insert into economic_data(id,publishdate,publishtime,country,indicator,importance,previousvalue,predictedvalue,publishedvalue,source,compareresult,predictedresult,advice,INDICATORID)values('"+UtilGuid.getGuid()+"',?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
//			String[] html=this.getHtml(pulishDate);
...
//			this.setTaskMsg(bean.getSource() + "数据采集执行成功[" + pulishDate + "]");
//		} catch (Exception e) {
...
//	 * @throws IOException 
//	 */
//	private String[] getHtml(String pulishDate) throws Exception{
...
//		conn.header("Cookie", "hqToken=Erb1SBfdUp-QgpvxKG2g7cNxYBTvxSU3OeSCdSeHSv8%3D; Hm_lvt_051084b7a2421f611f8d06f67e5eb797=1478776220,1478776544,1479042926,1479126796; Hm_lpvt_051084b7a2421f611f8d06f67e5eb797=1479126796; BAIDU_SSP_lcr=https://www.baidu.com/link?url=hoIBFOlhR8v7rQvlAKhSkGtWxSF8jUM3to-gepgKA4EZuCXxrQENtmY_p53snT9f&wd=&eqid=99f834d50000cad1000000035829af0a; CNZZDATA1259853823=1892554534-1478774064-null%7C1479125666");
