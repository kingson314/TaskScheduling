...
public class TaskPretrial extends TaskAbstract {
	...
	private final static String cls="gpcgd Pretrial";
	...
	private int exec(Bean bean) throws Exception {
		...
		for (int i = 1; i <= bean.getPageIndex(); i++) {
			...
			String url = "http://gpcgd.gd.gov.cn/gpcgd_buy_review/index.html";
			if(i>1) {
				url="http://gpcgd.gd.gov.cn/gpcgd_buy_review/index_"+i+".html";
			}
