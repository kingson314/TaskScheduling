...
public class TaskResult extends TaskAbstract {
	...
	private final static String cls="gpcgd Result";
	...
	private int exec(Bean bean) throws Exception {
		...
		for (int i = 1; i <= bean.getPageIndex(); i++) {
			...
			String url = "http://gpcgd.gd.gov.cn/gpcgd_buy_bidding_res/index.html";
			if(i>1) {
				url="http://gpcgd.gd.gov.cn/gpcgd_buy_bidding_res/index_"+i+".html";
			}
