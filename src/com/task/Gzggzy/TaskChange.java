...
public class TaskChange extends TaskAbstract {
	...
	private int exec(Bean bean) throws Exception {
		...
		for (int i = 1; i <= bean.getPageIndex(); i++) {
			...
			String url = "http://www.gzggzy.cn/cms/wz/view/index/layout2/zfcglist.jsp?channelId=457&page="+i;
...
//				System.out.println(UtilJackSon.toJson(list));
	...
	public static void main(String[] args) throws Exception {
		List<InfoBidChange> list = new ArrayList<InfoBidChange>();
		String url = "http://www.gzggzy.cn/cms/wz/view/index/layout2/zfcglist.jsp?channelId=457&page=1";
		Document doc = UtilWeb.getDoc(url);
		Elements elList = doc.getElementsByClass("wsbs-table").first().getElementsByTag("tr");
