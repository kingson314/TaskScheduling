...
/**
 * @Description:阳江市公共资源交易中心-变更公告公示
 * @date Aut 1,o19
 * @author:fgq
 */
public class TaskChange extends TaskAbstract {
	...
	private final static String cls="gzggzy Change";
	...
	private int exec(Bean bean) throws Exception {
		...
		for (int i = 1; i <= bean.getPageIndex(); i++) {
			...
			String url = "http://www.yjggzy.cn/Query/ArticleQuery2/1512d4cad92c44858cd52b85debbd8ed?page="+i;
...
//				System.out.println(UtilJackSon.toJson(list));
	...
	public static void main(String[] args) throws Exception {
		List<InfoBidChange> list = new ArrayList<InfoBidChange>();
		String url = "http://www.yjggzy.cn/Query/ArticleQuery2/1512d4cad92c44858cd52b85debbd8ed?page=1";
		Document doc = UtilWeb.getDoc(url);
		Elements elList = doc.getElementsByClass("list").first().getElementsByTag("li");
