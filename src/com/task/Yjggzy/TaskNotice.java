...
public class TaskNotice extends TaskAbstract {
	...
	private int exec(Bean bean) throws Exception {
		...
		for (int i = 1; i <= bean.getPageIndex(); i++) {
			...
			String url = "http://www.yjggzy.cn/Query/ArticleQuery2/465c897866824460b1783cfa20985510?page="+i;
...
//				System.out.println(UtilJackSon.toJson(list));
	...
	public static void main(String[] args) throws Exception {
		List<InfoBidNotice> list = new ArrayList<InfoBidNotice>();
		String url = "http://www.yjggzy.cn/Query/ArticleQuery2/465c897866824460b1783cfa20985510?page=1";
		Document doc = UtilWeb.getDoc(url);
		Elements elList = doc.getElementsByClass("list").first().getElementsByTag("li");
